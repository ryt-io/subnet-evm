...
//go:generate sh -c "sed -i.bak -e 's|github.com/ava-labs/libevm/accounts/abi|github.com/ryt-io/subnet-evm/accounts/abi|g' -e 's|github.com/ava-labs/libevm/accounts/abi/bind|github.com/ryt-io/subnet-evm/accounts/abi/bind|g' gen_warptest_binding.go && rm -f gen_warptest_binding.go.bak"
