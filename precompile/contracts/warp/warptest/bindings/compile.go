...
//go:generate go run github.com/ryt-io/libevm/cmd/abigen --pkg bindings --type WarpTest --abi artifacts/WarpTest.abi --bin artifacts/WarpTest.bin --out gen_warptest_binding.go
...
//go:generate sh -c "sed -i.bak -e 's|github.com/ryt-io/libevm/accounts/abi|github.com/ryt-io/subnet-evm/accounts/abi|g' -e 's|github.com/ryt-io/libevm/accounts/abi/bind|github.com/ryt-io/subnet-evm/accounts/abi/bind|g' gen_warptest_binding.go && rm -f gen_warptest_binding.go.bak"
