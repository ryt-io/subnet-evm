...
// Source: github.com/ryt-io/subnet-evm/internal/ethapi (interfaces: Backend)
//
...
import (
	...
	accounts "github.com/ryt-io/libevm/accounts"
	common "github.com/ryt-io/libevm/common"
	bloombits "github.com/ryt-io/libevm/core/bloombits"
	state "github.com/ryt-io/libevm/core/state"
	types "github.com/ryt-io/libevm/core/types"
	vm "github.com/ryt-io/libevm/core/vm"
	ethdb "github.com/ryt-io/libevm/ethdb"
	event "github.com/ryt-io/libevm/event"
	commontype "github.com/ryt-io/subnet-evm/commontype"
	consensus "github.com/ryt-io/subnet-evm/consensus"
	core "github.com/ryt-io/subnet-evm/core"
...
func (m *MockBackend) GetFeeConfigAt(parent *types.Header) (commontype.FeeConfig, *big.Int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetFeeConfigAt", parent)
...
// GetFeeConfigAt indicates an expected call of GetFeeConfigAt.
func (mr *MockBackendMockRecorder) GetFeeConfigAt(parent any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFeeConfigAt", reflect.TypeOf((*MockBackend)(nil).GetFeeConfigAt), parent)
}
